...
//  let selectedRegionNombre = regionSelect.value;
//  let selectedRegion = region_comuna["regiones"].find(region => region.nombre == selectedRegionNombre);
//  
//  comunaSelect.innerHTML = '<option value="">Seleccione una comuna</option>';
//
//  if (selectedRegion.comunas) {
